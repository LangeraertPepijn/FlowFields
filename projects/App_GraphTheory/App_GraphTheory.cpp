...
#pragma region UI
	{
		...
		auto eulirianity = eulerFinder.IsEulerian();
		
		auto temp = eulerFinder.FindPath(eulirianity);
		//switch (eulirianity)
		//{
		//case Elite::Eulerianity::notEulerian:
		//	std::cout << "not eulierian" << std::endl;
		//	break;
		//case Elite::Eulerianity::semiEulerian:
		//	std::cout << "semi eulierian" << std::endl;
		//	break;
		//case Elite::Eulerianity::eulerian:
		//	std::cout << "eulierian" << std::endl;
		//	break;
		//default:
		//	break;
		//}
